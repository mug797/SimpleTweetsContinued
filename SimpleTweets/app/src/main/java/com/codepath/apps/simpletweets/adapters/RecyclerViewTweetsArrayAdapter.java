...
public class RecyclerViewTweetsArrayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerViewTweetsArrayAdapter(Context context, List<Tweet> tweets){
        this.tweets = tweets;
