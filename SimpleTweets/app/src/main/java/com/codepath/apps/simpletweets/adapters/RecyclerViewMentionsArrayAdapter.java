...
public class RecyclerViewMentionsArrayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerViewMentionsArrayAdapter(Context context, List<Tweet> tweets){
        this.tweets = tweets;
