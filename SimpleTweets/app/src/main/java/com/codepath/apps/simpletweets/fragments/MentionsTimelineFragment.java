...
import com.codepath.apps.simpletweets.adapters.RecyclerViewMentionsArrayAdapter;
...
public class MentionsTimelineFragment extends TweetsListFragment {
    ...
    public RecyclerViewMentionsArrayAdapter aTweets;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        aTweets = new RecyclerViewMentionsArrayAdapter(getActivity(), tweets);
    ...
    public void populateTimeline(final boolean isScrolled, final boolean isRefreshed) {
        ...
        client.getMentionsTimeline(maxid, sinceid, isScrolled, isRefreshed, new TextHttpResponseHandler() {
            @Override
